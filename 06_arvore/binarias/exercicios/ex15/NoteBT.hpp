...
template <typename T > void NodeBT <T >:: addLeft ( NodeBT * subtree ) {
if ( left != nullptr ) delete left ;
left = subtree ;
if ( subtree != nullptr ) subtree -> parent = this ;
}
template <typename T > void NodeBT <T >:: addRight ( NodeBT * subtree ) {
if ( right != nullptr ) delete right ;
right = subtree ;
if ( subtree != nullptr ) subtree -> parent = this ;
}

template <typename T > void NodeBT <T >:: removeLeft () { addLeft ( nullptr ); }
template <typename T > void NodeBT <T >:: removeRight () { addRight ( nullptr ); }
